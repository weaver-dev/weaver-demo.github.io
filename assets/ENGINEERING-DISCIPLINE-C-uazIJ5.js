...
Weaver ships with engineering discipline you can verify, not just claim. Every commit passes <!-- auditor-count:begin -->87<!-- auditor-count:end --> static auditors. Every release passes a pre-flight simulation of downstream build contexts. Every public artifact carries provenance you can audit.
...
|---|---|---|
| Static analyzers per push | 1–2 generic tools (ESLint, tsc) | **<!-- auditor-count:begin -->87<!-- auditor-count:end -->** domain-specific auditors across 4 coverage categories |
...
Every push exercises the full set — failure anywhere blocks the merge. The <!-- auditor-count:begin -->87<!-- auditor-count:end --> auditors group into four coverage categories:
...
| Claim | How to verify |
|---|---|
| <!-- auditor-count:begin -->87<!-- auditor-count:end --> auditors on every push | [.github/workflows/test.yml](https://github.com/whizbangdevelopers-org/Weaver-Free/blob/main/.github/workflows/test.yml) compliance-suite job, or grep \`audit:\` in [package.json](https://github.com/whizbangdevelopers-org/Weaver-Free/blob/main/package.json) \`test:compliance\` script |
