...
6. **Two-person rule *inside the product itself*.** The product that Weaver ships *enforces* a two-person rule for privileged customer operations — specifically for binary-drop custom software ingestion (Decision WVR-149, Shed Builder Lane 1 at Team tier and above). Our customers get separation of duties out-of-the-box; we eat that in our product's own dogfooding tier when the company scales.
