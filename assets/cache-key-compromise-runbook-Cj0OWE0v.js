...
This runbook covers **compromise of the Attic signing key used by the Weaver Private Nix Cache (Decision WVR-147)**. A compromise means:
...
\`echo $?\` must print \`1\` — the file is gone.
...
**Pre-ship rehearsal status:** not yet rehearsed (v2.3 in development). Rehearsal is a blocking gate for v2.3 ship per Decision WVR-147.
